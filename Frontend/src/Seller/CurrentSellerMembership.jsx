...
function CurrentSellerMembership() {
  ...
  const renderMembershipBox = () => {
    if (membership.membershipType === 'sellaccess') {
      return (
      ...
      // ✅ Implement remove membership logic
    ...
    if (membership.membershipType === 'rentaccess') {
      return (
        <div className="card highlight" style={{width:"400px"}}>
          ...
          <button onClick={removeMembership} className="button purple-button disabled">Deactive</button>
        </div>
      );
    }
...
export default CurrentSellerMembership;
