    ...
    <div className="app-container">
      <div className="image-section">
        ...
        <div className="image-content">
          <h2 style={{color:"white"}}>Your Wheels,<br /> A website for Vehicle Enthusiasts</h2>
          <div className="dots">
            {images.map((_, index) => (
              <div
                key={index}
      ...
      <div className="form-section">
        ...
        <div className="form-container" style={{backgroundColor:"#1A1A1A"}}>
          <div className="form-header">
            <h1>Buyer Signup</h1>
            <p>Already have an account? <Link to="/buyer-login">Log in</Link></p>
          </div>
...
{emailSent && !emailVerified && <p >OTP sent successfully!</p>}
{emailVerified && <p >OTP verified successfully! 🎉</p>}
